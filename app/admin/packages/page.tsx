...
//   console.log("Features from form:", formData.get("features")); // Debug log
...
//     features: featuresValue ? (featuresValue as string).split(" ").map((tag) => tag.trim()) : [],
...
//       toast.success('Package Added Successfully'); // Changed to 'Package' for clarity
//       loadPackages();
//       window.location.reload();
//     } else {
//       toast.error('Failed to add Package'); // Changed to 'Package' for clarity
//     }
//   } catch (error) {
//     toast.error(`Failed Package Adding`);
...
//                       </DialogDescription>
//                     </DialogHeader>
//                     <form action={handleAddPackage} className="space-y-4">
//                       <div>
...
//                         />
//                       </div>
//                       <Button type="submit" className="w-full bg-gray-900 text-white hover:bg-gray-800">Create Package</Button>
//                     </form>
//                   </DialogContent>
//                 </Dialog>
//               </div>
